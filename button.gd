class_name SquareButton extends Sprite2D
...
@export var gradient_offset_speed: float = 1.0
...
@export var gradient_offset_step: float = 0.01
...
func _process(delta: float) -> void:
    ...
    gradient_offset += gradient_offset_direction * gradient_offset_step * gradient_offset_speed * delta
